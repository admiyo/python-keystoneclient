...
class ProtocolManager(base.CrudManager):
    ...
    def create(self, identity_provider_id, protocol_id, **kwargs):
        ...
        :param identity_provider_id: a string type parameter identifying an
            Identity Provider
    ...
    def update(self, identity_provider, protocol, **kwargs):
        ...
        :param protocol: a base.Resource type object with federation protocol
            id stored inside
        :param mapping: a base.Resource type object with federation mapping
            id stored inside.
